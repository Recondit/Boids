...
class Boid:
    ...
    def behaviour(self , boids):
        alignment , cohesion ,  seperation = self.boidrules(boids)
        self.acceleration[0] += alignment[0] + cohesion[0] + seperation[0]
        self.acceleration[1] += alignment[1] + cohesion[1] + seperation[1]

    def boidrules(self, boids):
        steering1 = [0, 0]
        total = 0
        avg_vec = [0, 0]
